...
boy = pg.image.load("bodyy.PNG").convert_alpha()
boy = pg.transform.smoothscale(boy, (420, 400))
boy_rect = boy.get_rect()
boy_rect.midbottom = (255, 498)  # ← делает стоячим внизу
